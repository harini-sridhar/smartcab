...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing == True:
            ...
            self.train_num += 1.0
            self.epsilon = math.e**(-self.alpha * self.train_num)
            #self.epsilon = 1/self.train_num**2
            #self.epsilon = 0.01 ** self.train_num
            #self.epsilon = math.cos(self.alpha*self.train_num)
    ...
    def get_maxQ(self, state):
        ...
        maxQ = all_actions[max(all_actions, key=all_actions.get)]
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if self.epsilon > random.random():
                ...
                maxQ_actions = [action for action,q in self.Q[state].iteritems() if q==maxQ]
